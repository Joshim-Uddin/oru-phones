...
const Drawer = () => {
  ...
  <div className="drawer-content">
    {/* Page content here */}
    <div className='flex items-center justify-between px-2 w-full md:border-none border-b border-gray-300 shadow-md shadow-gray-300'>
    ...
    <div className='md:absolute top-0 right-5 md:border-b md:w-full md:shadow-md md:border-gray-400 py-2 flex items-center justify-end gap-5 md:pe-10'>
      ...
      <div className='flex justify-between items-center gap-5 border py-1 px-2 rounded-md'>
  ...
  <div className="drawer-side">
    ...
    <ul className="menu p-4 md:w-64 w-56 h-full bg-base-200 text-base-content">
      ...
      <div className='flex items-center w-full mb-4'><BsChevronRight /><li className='rounded-md w-11/12 hover:border hover:border-black'><a>My Profile</a></li></div>
      <div className='flex items-center w-full'><BsChevronRight /><li className='rounded-md w-11/12 hover:border hover:border-black'><a>My Connections</a></li></div>
    </ul>
